...
<body>
  ...
  <script>
    ...
    // 🎵 Apple Music – Raindance
    const songLink = "https://music.apple.com/us/album/raindance/1847992481?i=1847992612";
    ...
    // ✅ YES → show message, then redirect (never blocked)
    yesBtn.addEventListener("click", () => {
      card.innerHTML = `
        <h2>She said YES 🥹💕</h2>
        <p>Bestfriends again.<br>Forever this time 🤞🏽💗</p>
        <p class="tiny">Playing our song 🎶💖</p>
      `;
